...
export class HomeComponent implements OnInit {
  ...
  constructor(protected shopService: ShopService, private eventManager: JhiEventManager) {
    this.eventManager.subscribe('shopsInHomepage', (response: JhiEventWithContent<IShop[]>) => {
